...
class KeyStore:
    """Gestion locale de clés : le secret brut n'est jamais écrit dans SQLite."""
...
def command_key_create(args: argparse.Namespace) -> int:
    try:
...
def command_key_revoke(args: argparse.Namespace) -> int:
...
def build_parser() -> argparse.ArgumentParser:
    ...
    key = subparsers.add_parser("key", help="Gérer les clés d'accès")
    ...
    create.set_defaults(func=command_key_create)
